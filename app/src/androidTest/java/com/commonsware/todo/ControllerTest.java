...
public class ControllerTest {
    ...
    public void controller() throws InterruptedException {
        ...
        Result.Loaded resultLoaded = (Result.Loaded) receivedResults.poll(1, TimeUnit.SECONDS);
        ...
        Result.Added resultAdded = (Result.Added) receivedResults.poll(1, TimeUnit.SECONDS);
        ...
        Result.Filtered resultFiltered = (Result.Filtered) receivedResults.poll(1, TimeUnit.SECONDS);
